...
List<Widget> generateListImages(List<String> images, context) {
  return List.generate(
    images.length,
    (index) => myImageContainer(images[index], context),
  );
}

Widget myAddressLastHouse(double currentWidth) {
  return Padding(
    ...
    child: Column(
      children: [
        ...
        Padding(
          padding: EdgeInsets.all(8.0),
          child: Image(
            image: NetworkImage(carouselItems[0]),
            fit: BoxFit.cover,
          ),
        ),
      ],
...
Widget myCarouselSlider(double childHeight, context) {
  return CarouselSlider(
    items: generateListImages(imagesList, context),
...
Widget myImageContainer(String url, context) {
  return Container(
...
Widget myData1(double currentWidth, double currentHeight, context) {
  return Column(
    ...
    children: [
      ...
      //Carousel Slider
      myCarouselSlider(currentHeight * 0.45, context),
      /*
                    setMyCarousel(
                      carouselItems,
                      context,
...
Widget myData2(double currentWidth) {
  return Column(
    children: <Widget>[
      Align(
        alignment: Alignment.topLeft,
