...
- Adição de código de checagem de internet apresenta instabilidades, é apenas um teste de funcionalidade<br>por hora
está no caminho: ```Rent_a_House_App/Releases/TP_S4/teste conexao```
- 24-05-2025: Adição de código de checagem de internet apresenta instabilidades, é apenas um teste de<br>funcionalidade
por hora - teste de permissões(AndroidManifest refeito do zero).<br>Caminho do código:```Rent_a_House_App/Releases/TP_S4/alpha```
