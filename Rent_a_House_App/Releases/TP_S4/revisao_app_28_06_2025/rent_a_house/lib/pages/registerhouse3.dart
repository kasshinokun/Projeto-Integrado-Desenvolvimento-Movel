...
class _RegisterHousePageState extends State<RegisterHousePage> {
  ...
  // ATUALIZADO: Lista para armazenar múltiplas imagens selecionadas
  ...
  //====================================================================================================
  // ATUALIZADO: Função para selecionar MÚLTIPLAS imagens
  Future<void> _pickImages() async {
    ...
    try {
      ...
      if (pickedFiles.isNotEmpty) {
        setState(() {
          // Adiciona as novas imagens, respeitando o limite
          for (XFile xFile in pickedFiles) {
            if (_pickedHouseImages.length < _maxImages) {
              _pickedHouseImages.add(File(xFile.path));
            } else {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Falha ao selecionar imagens: $e')),
      );
    }
  }
  ...
  // ====================================================================================================
  // NOVA FUNÇÃO PARA SALVAR DETALHES DO IMÓVEL NO FIRESTORE
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // ATUALIZADO: Campo para a Imagem do Imóvel (agora uma lista horizontal)
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: _pickImages, // Chama a função para selecionar MÚLTIPLAS imagens
                        icon: const Icon(Icons.add_photo_alternate),
                        label: Text(
                          _pickedHouseImages.length < _maxImages
                              ? 'Adicionar Imagens (${_pickedHouseImages.length}/$_maxImages)'
              ...
              ElevatedButton.icon(
                onPressed: _saveHouseDetailsToFirestore, // Chama a nova função
