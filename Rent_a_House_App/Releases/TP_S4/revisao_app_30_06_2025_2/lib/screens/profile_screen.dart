                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: (userPhotoPath != null && File(userPhotoPath).existsSync())
                        ...
                        : AssetImage("assets/app/user.png"), // Fallback para asset local ou padrão
            ...
            (user != null && !user.isAnonymous)? // Verifica se o user não é nulo E não é anônimo
              Column(
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _buildQuickAccessItem(Icons.house, "Meus Imóveis", Colors.green, () => _showSnackBar(context, "Funcionalidade de Ver Meus Imóveis")),
                      const SizedBox(width: 20),
                ...
                _buildActionCard(
                  ...
                  title: 'Meus Imóveis',
                  onTap: () {
                    Navigator.pushNamed(context, '/myhouses'); // Navegação para a tela de registro de imóvel
                  },
                ),
                _buildActionCard(
                  icon: Icons.list_alt,
